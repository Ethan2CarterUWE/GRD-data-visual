...
public class WorldMap : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    public void SelectCountry(Country country)
    {
        ...
        if (DataRANKING <= 10)
        {
            //countryT.GetComponent<SpriteRenderer>().color = new Color(1,0,1,1);
            countryT.GetComponent<SpriteRenderer>().color = mapStyleController.top10COUNTRY;


        }

        else if (DataRANKING <= 25)
        {
            //countryT.GetComponent<SpriteRenderer>().color = new Color(1,0,1,1);
            countryT.GetComponent<SpriteRenderer>().color = mapStyleController.top25COUNTRY;
        }
        else if (DataRANKING <= 50)
        {
            //countryT.GetComponent<SpriteRenderer>().color = new Color(1,0,1,1);
            countryT.GetComponent<SpriteRenderer>().color = mapStyleController.top50COUNTRY;
        }
        else if (DataRANKING <= 75)
        {
            //countryT.GetComponent<SpriteRenderer>().color = new Color(1,0,1,1);
            countryT.GetComponent<SpriteRenderer>().color = mapStyleController.top75COUNTRY;
        }
        else if (DataRANKING <= 100)
        {
            //countryT.GetComponent<SpriteRenderer>().color = new Color(1,0,1,1);
            countryT.GetComponent<SpriteRenderer>().color = mapStyleController.top100COUNTRY;
        }
        else if (DataRANKING <= 150)
        {
            //countryT.GetComponent<SpriteRenderer>().color = new Color(1,0,1,1);
            countryT.GetComponent<SpriteRenderer>().color = mapStyleController.top150COUNTRY;
        }
        else if (DataRANKING <= 200)
        {
            //countryT.GetComponent<SpriteRenderer>().color = new Color(1,0,1,1);
            countryT.GetComponent<SpriteRenderer>().color = mapStyleController.top200COUNTRY;
        }
        /* else
         {
             //countryT.GetComponent<SpriteRenderer>().color = new Color(1,0,1,1);
